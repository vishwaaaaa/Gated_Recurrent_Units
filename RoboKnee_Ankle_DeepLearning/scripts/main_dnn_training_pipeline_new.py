...
with open('../datatrain1_structure.pkl', 'rb') as f:
    data_structure = pickle.load(f)
del f

with open('../test_structure.pkl', 'rb') as f:
...
constants = set_parameters.get_constants(device=device, input_size=7, output_size=2, optuna_trials=1, num_timestepsPerTrial=4000, fs=120)
...
for model_type in model_types:
    ...
    with open('test_GRUmodel2_results_dict.pickle', 'wb') as f:
