...
pickle_file = 'Data_train\datatrain2new_structure.pkl'
...
for folder_name2 in os.listdir(data_directory): # AB0, AB1
    ...
    for folder_name in os.listdir(folder_path1): # normal_walk folder
        ...
        dfs = []
        # Check if the item in the directory is a folder
        if os.path.isdir(folder_path) and folder_path.__contains__('AB05')==True and (folder_path.__contains__('tug_of_war_1')  or folder_path.__contains__('jump_1_2_vertical') ) :#(folder_path.__contains__('normal_walk_1_1-2') or folder_path.__contains__('incline_walk_2_up10')  or folder_path.__contains__('jump_1_vertical')) and (folder_path.__contains__('_skip')==False) and folder_path.__contains__('AB01')==True :
            # Iterate through each file in the folder
            ###############################################
            files_ = sorted(os.listdir(folder_path))[-3]
            import numpy as np
...
# Define the filename for the pickle file
pickle_file = 'Data_train/test_newstructure.pkl'
