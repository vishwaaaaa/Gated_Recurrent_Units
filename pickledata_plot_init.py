...
for folder_name2 in os.listdir(data_directory): # AB0, AB1
    ...
    for folder_name in os.listdir(folder_path1): # normal_walk folder
        ...
        if os.path.isdir(folder_path) and (folder_path.__contains__('normal_walk_') or folder_path.__contains__('incline_walk_')  or folder_path.__contains__('jump_')) and (folder_path.__contains__('_skip')==False) and  (folder_path.__contains__('AB01')==True or folder_path.__contains__('AB02')==True or folder_path.__contains__('AB03')==True or folder_path.__contains__('AB04')==True ) :
            ...
            for file_name in os.listdir(folder_path):
                ...
                if os.path.isfile(file_path) and (file_name.__contains__('_normal_walk_') or file_name.__contains__('_incline_walk_') or file_name.__contains__('_jump_')) and (file_name.__contains__('_skip')==False) and (file_name.__contains__('_emg')==False) and (file_name.__contains__('_moment_filt') or file_name.__contains__('_angle') or file_name.__contains__('_emg') or file_name.__contains__('_imu_real') or file_name.__contains__('_velocity') ):
                    # Read the CSV file into a Pandas DataFrame
                    print(file_path)
                    ...
                    if file_name.__contains__('_angle'):
                        ...
                        select = df[column]
                        dfs.append(select)    
                    # elif file_name.__contains__('_emg'):
...
pickle_file = 'datatrain2_structure.pkl'
...
for folder_name2 in os.listdir(data_directory): # AB0, AB1
    ...
    for folder_name in os.listdir(folder_path1): # normal_walk folder
        ...
        dfs = []
        # Check if the item in the directory is a folder
        if os.path.isdir(folder_path) and (folder_path.__contains__('normal_walk_1_1-2') or folder_path.__contains__('incline_walk_2_up10')  or folder_path.__contains__('jump_1_vertical')) and (folder_path.__contains__('_skip')==False) and folder_path.__contains__('AB01')==True :
            # Iterate through each file in the folder
            ###############################################
            files_ = sorted(os.listdir(folder_path))[-3]
            import numpy as np
...
# Define the filename for the pickle file
pickle_file = 'test_structure.pkl'
